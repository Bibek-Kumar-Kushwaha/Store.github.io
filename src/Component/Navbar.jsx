...
const Navbar = () => {
    ...
    return (
        <>
            <div className=" w-full font-bold md:text-2xl text-xl">
                <div className="w-[95%] m-auto flex justify-evenly ">
                    ...
                    {/* *************Menu*********** */}
                    <div className={` ${toggle ? 'block' : 'hidden'} fixed md:static md:block my-auto  h-1/2 md:w-[60%] w-full top-14 left-0 bg-slate-200 md:bg-white z-10 `}>
                        <ul className="md:flex justify-evenly font-bold text-xl text-center w-[80%] mx-auto my-4 ">
                            {data.map((item, index) => (
                                <li key={index} className="my-5 md:my-0 mx-2">
                                    <ScrollLink
                                        to={item.link}
